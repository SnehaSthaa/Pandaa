  ...
  return (
    <>
      <div className={cn(className)}>
        ...
        <button className="border-primary-white rounded-sm border p-0.5 text-[5px] hover:m-0 hover:cursor-pointer hover:bg-[#bcbcbc] md:p-2 md:text-sm lg:m-2 lg:p-3 lg:text-sm">
          Contact us
        </button>
      </div>
    </>
